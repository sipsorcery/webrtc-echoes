/******************************************************************************
* Filename: fake_Audio_capture_module.cc
*
* Description:
...
* 
* Original:
* https://webrtc.googlesource.com/src/+/refs/heads/main/pc/test/fake_audio_capture_module.cc
*
* History:
...
FakeAudioCaptureModule::~FakeAudioCaptureModule() {
  std::cout << "~FakeAudioCaptureModule" << std::endl;
}
